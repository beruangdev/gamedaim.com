...
-- CreateEnum
CREATE TYPE "TopicType" AS ENUM ('ALL', 'ARTICLE', 'REVIEW', 'TUTORIAL', 'DOWNLOAD', 'MOVIE', 'TV', 'GAME');

-- CreateEnum
CREATE TYPE "AdType" AS ENUM ('ADSENSE', 'PLAIN_AD');

-- CreateEnum
CREATE TYPE "AdPosition" AS ENUM ('HOME_BELOW_HEADER', 'ARTICLE_BELOW_HEADER', 'TOPIC_BELOW_HEADER', 'DOWNLOAD_BELOW_HEADER', 'SINGLE_ARTICLE_ABOVE_CONTENT', 'SINGLE_ARTICLE_MIDDLE_CONTENT', 'SINGLE_ARTICLE_BELOW_CONTENT', 'SINGLE_ARTICLE_POP_UP', 'SINGLE_DOWNLOAD_ABOVE_CONTENT', 'SINGLE_DOWNLOAD_MIDDLE_CONTENT', 'SINGLE_DOWNLOAD_BELOW_CONTENT', 'SINGLE_DOWNLOAD_POP_UP');
