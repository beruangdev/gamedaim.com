...
-- CreateTable
CREATE TABLE "ArticleParent" (
    "id" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ArticleParent_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "TopicParent" (
    "id" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "TopicParent_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ArticleParent_id_key" ON "ArticleParent"("id");
...
-- CreateIndex
CREATE UNIQUE INDEX "TopicParent_id_key" ON "TopicParent"("id");
...
-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_articleParentId_fkey" FOREIGN KEY ("articleParentId") REFERENCES "ArticleParent"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Topic" ADD CONSTRAINT "Topic_topicParentId_fkey" FOREIGN KEY ("topicParentId") REFERENCES "TopicParent"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
