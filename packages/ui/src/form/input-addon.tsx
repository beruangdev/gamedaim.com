...
export const InputAddon: React.FunctionComponent<InputAddonProps> = (props) => {
  const { placement = "left", size = "md", className, ...rest } = props

  const classes = cn(
    "flex items-center w-auto rounded-md shadow-sm whitespace-nowrap border border-theme-300 text-theme-600 bg-theme-50 dark:border-theme-700 dark:text-theme-100 dark:bg-theme-300",
    sizeClasses[size],
