...
interface AddTopicsProps extends React.HTMLAttributes<HTMLFormElement> {
  topics: string[]
...
export const AddTopicsAction = React.forwardRef<
  HTMLFormElement,
  AddTopicsProps
>((props, ref) => {
          ...
          <div className="parent-focus flex max-w-[300px] flex-row flex-wrap items-center justify-start gap-2 p-2">
            {selectedTopics.length > 0 &&
              selectedTopics.map((topic) => {
                return (
                  <div
                    className="bg-theme-200 dark:bg-theme-800 flex items-center px-2 py-1 text-[14px] text-black dark:text-white"
                    key={topic.id}
                  >
