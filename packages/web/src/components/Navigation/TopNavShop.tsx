...
export const TopNavShop = React.forwardRef<HTMLDivElement, TopNavProps>(
  (props, ref) => {
    ...
    return (
      <header
        className="opacity-1 bg-background fixed left-auto top-0 z-[49] -my-0 mx-auto box-border flex h-16 w-full items-center border-none px-2 py-0 align-baseline shadow-lg outline-none"
        ref={ref}
        {...rest}
      >
              ...
              <div className="flex w-[250px]">
                ...
                <div className="ak-bar-item ak-header-logo flex w-full flex-row flex-wrap items-center justify-start pl-0 pr-0">
                  <h2 className="m-0 p-0 text-4xl font-bold leading-none">
                    <NextLink aria-label="Go To Homepage" href="/shop">
